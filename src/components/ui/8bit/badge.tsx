...
function Badge({
  ...
  return (
    <div className={cn("relative inline-flex items-center justify-center", containerClasses)}>
      <ShadcnBadge
        {...props}
        className={cn(
          "h-full",
          "rounded-none",
          "w-full",
          "inline-flex items-center justify-center leading-none text-center",
          font !== "normal" && "retro",
          visualClasses
        )}
        variant={variant}
      ...
      <div
        className={cn(
          "-left-1.5 absolute inset-y-[3px] w-1.5",
          color,
          visualClasses
        )}
      />
      ...
      <div
        className={cn(
          "-right-1.5 absolute inset-y-[3px] w-1.5",
          color,
          visualClasses
        )}
      />
